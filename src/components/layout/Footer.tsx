  ...
  return (
    <footer className="bg-navy text-white/70 pt-16" role="contentinfo">
      <div className="max-w-[1280px] mx-auto px-6">
        {/* Desktop: 5 columns (brand + 4 nav). Mobile: brand on top, then 2-col nav grid */}
        <div className="flex flex-col md:grid md:grid-cols-5 gap-8 mb-12">
          ...
          {/* Nav columns: 2-col on mobile, span 4 cols on desktop */}
          <div className="grid grid-cols-2 md:contents gap-8 text-center md:text-left">
            <div>
