---
title: "Open Frame Monitors | Industrial LCD | US Micro Products"
description: "20 open frame monitors for kiosks, gaming, POS & industrial use. Multiple sizes with optional touch. VESA mount compatible. Request specifications."
keywords: ["open frame monitor manufacturer", "open frame LCD", "kiosk monitor", "industrial open frame display"]
url: "/products/open-frame-monitors"
...
- **LCD panel** — TFT LCD in sizes from 7" to 55"+
- **Controller/driver board** — Accepts standard video inputs (HDMI, VGA, DVI, DisplayPort)
- **Power supply** — Internal or external, AC or DC input options
- **Mounting hardware** — VESA-compatible mounting holes, brackets, or flanges
...
- **VGA** — Analog input for legacy system compatibility.
- **DVI** — Digital video for industrial and commercial systems.
...
- **[Kiosk & POS](/applications/kiosk-pos)** — Self-service terminals, ordering kiosks, check-in stations, ATMs
- **[Gaming](/applications/gaming)** — Slot machines, video poker, player tracking, sports betting terminals
- **[Industrial](/applications/industrial)** — Operator panels, SCADA displays, machine vision monitors
- **[Medical](/applications/medical)** — Bedside terminals, pharmacy dispensing, waiting room displays
- **[Instrumentation](/applications/instrumentation)** — Test station displays, data acquisition monitors

## Customization

- Custom brightness levels (standard through sunlight-readable)
- Touch integration (PCAP or resistive, bonded or air-gap)
- Custom cover glass with printing, coatings, and treatments
- Modified input configurations (add/remove video inputs)
- Custom cables and connectors
- Modified mounting solutions for non-VESA installations

---

[Request a Quote](/support/request-quote) | [Learn About Open Frame Monitors](/learn/open-frame-monitors) | [Contact Engineering](/contact)
